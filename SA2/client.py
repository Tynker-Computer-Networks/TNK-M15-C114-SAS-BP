...
def roll_dice():
    ...
    print(value)
    # Send value player1_turn to server
    

# Define the function to receive message

    # Access SERVER, canvas2 and dice as global
    ...
    # Create an infinite loop   
        ...
        # Check which '⚀' icon i.e '\u2680', the message matches with
        
            # Use itemconfigure() method on canvas2 to configure dice and set text to given text code
            
        # Repeat this for rest of the dice values i.e '\u2681', '\u2682' ... '\u2685'
...
def setup():
    ...
    # Create a thread that targets received_msg() function
